...
[NOTE]
====
The duplicate button icon:ArrowIcon[] will copy the query to the clipboard.
...
https://neo4j.com/graphacademy[Neo4j GraphAcademy - completely free online courses^]
