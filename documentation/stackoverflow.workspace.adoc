...
image::{images}/so_logo.svg[float=right,width=200px]
...
If you want to you, can also materialize those relationships in the graph and then explore the data in the _Explore_ tab, visually forming clusters.
